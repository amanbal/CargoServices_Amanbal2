...
namespace CargoServices_Amanbal.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,VehicleNo,VehicleTypeID")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,VehicleNo,VehicleTypeID")] Vehicle vehicle)
        {
            if (id != vehicle.ID)
            {
                return NotFound();
